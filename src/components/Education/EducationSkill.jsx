                ...
                <Container>
                    <div className='flex md:flex-row flex-col justify-between text-white md:mt-[50px]'>
                        <div className='text-white flex flex-col md:w-[30%] md:py-15 py-10 md:px-10 md:space-y-10 space-y-5 bg-transparent rounded-tl-2xl rounded-bl-2xl'>
                            ...
                            <NavLink className={(e) => { return e.isActive ? "white" : "" }} to="/educationSkill"> <button className="w-full py-[10px] border-2 border-[#0cf199] rounded-[15px] bg-[#0cf199] md:text-[24px] font-semibold text-black transition-all duration-300 ease-in cursor-pointer">Skill </button></NavLink>
                        ...
                        <div className='md:w-[70%] bg-transparent md:px-10 rounded-tr-2xl rounded-br-2xl md:py-15'>
                            ...
                            <div className='h-[450px] overflow-y-scroll md:px-5 py-2 tracking-[2px]'>
                                <div className='flex justify-between items-center'>
                                    <div className='flex flex-col items-center md:w-[200px]  w-[110px] bg-gray-200/10 md:py-10 py-5 md:px-15 px-5 rounded-[15px] cursor-pointer hover:scale-105 transition-all duration-100'>
