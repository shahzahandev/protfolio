                ...
                <Container>
                    <div className='flex md:flex-row flex-col justify-between text-white md:mt-[50px]'>
                        <div className='text-white flex flex-col md:w-[30%] md:py-15 py-10 md:px-10 md:space-y-10 space-y-5 bg-transparent rounded-tl-2xl rounded-bl-2xl'>
                            ...
                            <NavLink className={(e) => { return e.isActive ? "white" : "" }} to="/educationInfo"><button className="w-full py-[10px] border-2 border-[#0cf199] rounded-[15px] md:text-[24px] font-semibold text-[#0cf199] bg-transparent transition-all duration-300 ease-in hover:border-white hover:text-white cursor-pointer">Education</button></NavLink>
                           ...
                           <NavLink className={(e) => { return e.isActive ? "white" : "" }} to="/Info"> <button className="w-full py-[10px] border-2 border-[#0cf199] rounded-[15px] bg-[#0cf199] md:text-[24px] font-semibold text-black transition-all duration-300 ease-in  cursor-pointer">About</button></NavLink>
                        </div>
                        <div className='md:w-[70%] bg-transparent md:px-10 rounded-tr-2xl rounded-br-2xl md:py-15'>
                            ...
                            <p className="md:text-[14px] text-[13px] text-[#c9c4c4] md:mt-[20px] mt-[10px] tracking-[1px] md:leading-7 leading-6 mb-5">Creative frontend developer building modern, responsive, and interactive web experiences.</p>
                        </div>
                            <div className='md:h-[450px] overflow-y-scroll md:px-5 py-2'>
                                <div className='flex md:flex-row flex-col justify-between text-white md:space-x-[10px] md:mt-2 mt-0'>
                                    ...
                                    <div className='flex flex-col md:space-y-10 space-y-5 tracking-[.75px] md:w-[60%] md:px-1 md:py-5 md:mt-0 mt-3'>
                                        ...
                                        <h3 className='md:text-[20px] text-[18px] text-white font-semibold '><span className='md:text-[16px] text-[14px] text-[#c9c4c4] lowercase mr-4'>email </span> shahzahansiraj516@gmail.com</h3>
