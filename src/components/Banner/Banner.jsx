        ...
        <Container>
          <div className="md:flex md:justify-between items-center md:px-0 px-5">
            ...
            <div className="md:w-[70%]">
              ...
              <h1 className="md:text-6xl text-[34px] md:w-auto w-[400px] font-semibold text-[#0cf199] md:mt-[15px]">Shahzahan Siraj</h1>
              <h3 className="md:text-3xl text-[#c9c4c4] md:mt-[20px] md:w-auto w-[400px]">And I'm a <span className="md:text-4xl text-[22px] text-[#eafaf8]">Frontend Developer</span></h3>
              ...
              <div className="font-main text-white  md:mt-10 mt-5">
