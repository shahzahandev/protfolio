...
const Banner = () => {
  ...
  return (
    <>
          <div className="bg-gray-800 font-primary md:pt-[200px] pt-[100px] md:pb-[60px] pb-[50px]">
        <Container>
        <div className="md:flex md:justify-between items-center md:tracking-[1.5px] tracking-[1px] md:px-0 px-5">
           <div className="flex items-center ml-10 md:hidden w-[80%] relative drop-shadow-[0_5px_25px_rgb(12_241_153_/_.5)]">
            ...
            <div className="w-[70%]">
              ...
              <div className="flex md:flex-row flex-col items-center md:ml-0 ml-25 md:mt-[40px] mt-5 md:space-x-10 md:space-y-0 space-y-5">
              ...
              <div className="font-main text-white flex md:flex-row flex-col items-center md:mt-15 mt-8 md:ml-0 ml-30 md:space-y-0 space-y-5">
