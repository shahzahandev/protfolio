      ...
      <div className="bg-gray-800 font-primary md:pt-[200px] pt-[100px] md:pb-[50px] pb-[50px] overflow-y-hidden tracking-[1px] ">
        <Container>
          <div className="md:flex md:justify-between items-center md:px-0 px-5">
            ...
            <div className="md:w-[70%] md:text-start text-center md:mt-0 mt-8">
              <h4 className="md:text-[24px] text-[#c9c4c4]">Hello, It's Me</h4>
              <h1 className="md:text-6xl text-[34px] md:w-auto w-[300px] mx-auto font-semibold text-[#0cf199] md:mt-[15px]">Shahzahan Siraj</h1>
              <h3 className="md:text-3xl text-[#c9c4c4] md:mt-[20px] md:w-auto w-[330px] mx-auto ">And I'm a <span className="md:text-4xl text-[22px] text-[#eafaf8]">Frontend Developer</span></h3>
              <p className="md:text-[16px] text-[14px] text-[#c9c4c4] md:w-[500px] w-aut0 md:mt-[20px] mt-2 leading-7">I specialize in creating pixel-perfect, high-performance Website & web applications using modern technologies like HTML, CSS, Bootstrap, Tailwind, React & Javascript.</p>
              ...
              <div className="font-main text-white  md:mt-10 mt-5 md:block hidden">
                  <ul className="flex md:space-x-[110px] space-x-10 text-[#0cf199]">
