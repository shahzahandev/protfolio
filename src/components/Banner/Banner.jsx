        ...
        <Container>
          <div className="md:flex md:justify-between items-center  tracking-[1px] md:px-0 px-5 scroll- ">
            ...
            <div className="md:w-[70%]">
              ...
              <h1 className=" md:tracking-[2px] tracking-[2px] md:text-6xl text-[36px] md:w-auto w-[300px] font-semibold text-[#0cf199] md:mt-[15px]">Shahzahan Siraj</h1>
              ...
              <p className="md:text-[16px] text-[14px] text-[#c9c4c4] md:w-[500px] w-[350px] md:mt-[20px] mt-4 tracking-[1px] leading-7">I specialize in creating pixel-perfect, high-performance Website & web applications using modern technologies like HTML, CSS, Bootstrap, Tailwind, React & Javascript.</p>
              <div className="flex md:flex-row flex-col items-center md:mt-[40px] mt-5 md:space-x-10 md:space-y-0 space-y-5">
                <button className="flex items-center md:px-[32px] px-[100px] md:py-[13px] py-[10px] border-2 border-[#0cf199] rounded-[50px] bg-transparent text-[14px] font-semibold text-[#0cf199]  transition-all duration-300 ease-in hover:border-white hover:text-white md:w-auto w-[370px] cursor-pointer">DOWNLOAD CV
                ...
                <ul className="flex md:space-x-[50px] space-x-10 text-[#0cf199]">
                  ...
                  <li className="relative border-2 rounded-[50%] p-2 text-[24px] transition-all duration-200 ease-in hover:text-white">
