                ...
                <Container>
                    <div className='flex md:justify-between md:flex-row flex-col items-center md:space-x-[50px] space-y-15'>
                        <div className='md:w-[50%] border-b-2 text-white/50 md:pb-10 pb-5 md:px-0'>
                            <h3 className='md:text-8xl text-5xl text-white uppercase font-bold'>05</h3>
                            <h2 className='md:text-4xl text-2xl text-[#0cf199] font-bold  mt-[20px] '>Frontend Project <span className='md:text-2xl text-[16px] md:ml-3 inline-block'>( Quriarbox )</span></h2>
                            ...
                            <div className='mt-5 flex items-center space-x-10'>
                                ...
                                <h2 className='md:text-[18px] text-[14px] font-bold text-[#0cf199] tracking-[2px]'>Bootstrap</h2>
                            </div>
