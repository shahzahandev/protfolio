                ...
                <Container>
                    <div className='flex justify-between items-center space-x-[50px]'>
                        <div className='w-[50%] border-b-2 text-white/50 pb-10'>
                            <h3 className='text-8xl text-white uppercase font-bold'>04</h3>
                            <h2 className='text-4xl text-[#0cf199] font-bold  mt-[20px] tracking-[3px]'>Frontend Project <span className='text-2xl ml-3 tracking-[1px]'>( Petroil )</span></h2>
                        ...
                        <div className='w-[50%]'>
                            <img src={project4} alt="" className='h-[500px]' />
                        </div>
                    </div>
                </Container>
            </div>
