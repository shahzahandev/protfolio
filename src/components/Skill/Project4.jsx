                ...
                <Container>
                    <div className='flex md:justify-between md:flex-row flex-col items-center md:space-x-[50px]'>
                        <div className='md:w-[50%] border-b-2 text-white/50 pb-10 md:px-0'>
                            <h3 className='md:text-8xl text-6xl text-white uppercase font-bold'>04</h3>
                            <h2 className='md:text-4xl text-2xl text-[#0cf199] font-bold  mt-[20px] tracking-[3px]'>Frontend Project <span className='md:text-2xl text-[16px] md:ml-3 tracking-[1px] inline-block'>( Petroil )</span></h2>
                            ...
                            <div className='flex items-center space-x-5 md:mt-8 mt-5'>
                                ...
                                <div className="flex justify-center items-center md:w-[50px] w-[40px] md:h-[50px] h-[40px] rounded-[50%] p-2 text-[24px] bg-gray-700 transition-all duration-200 ease-in hover:bg-[#0cf199]">
                                    <a href="https://petroil516.vercel.app"><FaGithub className='text-3xl text-white hover:text-black' /></a>
                                </div>
                            </div>
                        </div>
                        <div className='md:w-[50%]'>
                            <img src={project4} alt="" className='md:h-[500px] h-[350px]' />
                        </div>
                    </div>
                </Container>
     </div>
