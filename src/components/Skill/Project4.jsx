...
const Project4 = () => {
  return (
    <>
     <div className='md:pt-[200px] pt-[50px] md:pb-[150px] pb-[50px] bg-gray-800 font-primary md:tracking-[1px]'>
                <Container>
                    <div className='flex md:justify-between md:flex-row flex-col items-center md:space-x-[50px] space-y-15'>
                        <div className='md:w-[50%] border-b-2 text-white/50 md:pb-10 pb-5 md:px-0'>
                            ...
                            <h2 className='md:text-4xl text-2xl text-[#0cf199] font-bold  mt-[20px] tracking-[3px]'>Frontend Project <span className='md:text-2xl text-[16px] md:ml-3 inline-block'>( Petroil )</span></h2>
