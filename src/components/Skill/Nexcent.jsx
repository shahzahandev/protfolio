                ...
                <Container>
                    <div className='flex md:justify-between md:flex-row flex-col items-center md:space-x-[50px] space-y-0'>
                        <div className='md:w-[50%] md:border-b-2 border-secondary md:pb-10 pb-5 md:px-0'>
                            <h3 className='md:text-8xl text-4xl text-text uppercase font-bold'>03</h3>
                            <h2 className='md:text-4xl text-2xl text-heading font-bold  md:mt-[20px] mt-2'>NexCent</h2>
                            <p className='md:mt-[20px] mt-[10px] md:text-[16px] text-[12px] font-medium text-text md:w-auto w-[350px]'>A fully responsive business website inspired by Nexcent, built with HTML, CSS, Bootstrap, and JavaScript, featuring interactive layouts and mobile-friendly design.</p>
                            ...
                            <div className='flex items-center space-x-10 md:mt-8 mt-2'>
                                <div className="flex justify-center items-center gap-x-2 md:text-[14px] font-semibold text-[10px] text-heading transition-all duration-200 ease-in ">
                                    <a href="https://github.com/shahzahandev/nexcent-project"><FaExternalLinkAlt className='md:text-2xl text-[16px]  text-heading' /></a>
                        ...
                        <div className='md:w-[50%]'>
                            <img src={project3} alt="" className='md:h-[500px] h-[350px] border-white/90' />
                        </div>
                    </div>
                </Container>
            </div>
