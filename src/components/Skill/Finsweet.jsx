                ...
                <Container>
                    <div className='flex md:justify-between md:flex-row flex-col items-center md:space-x-[50px] space-y-0'>
                        <div className='md:w-[50%] md:border-b-2 text-white/50 md:pb-10 pb-5 md:px-0'>
                            ...
                            <h2 className='md:text-4xl text-2xl text-[#0cf199] font-bold  md:mt-[20px] mt-2'>Finsweet</h2>
                            ...
                            <div className='flex items-center space-x-10 md:mt-8 mt-2'>
                                  <div className="flex justify-center items-center p-2 rounded-[50%]  text-[24px]  transition-all duration-200 ease-in border-2 border-[#0cf199] hover:shadow-[0px_0px_10px_rgba(12,241,153,.5)]">
                                    <a  href="https://github.com/shahzahandev/finsweet"><FaGithub className='text-2xl text-[#0cf199]' /></a>
                                </div>
                                 <a href="">
                        ...
                        <div className='md:w-[50%]'>
                            <img src={finsweet} alt="" className='md:h-[500px] h-[350px] border-15 border-white/90' />
                        </div>
                    </div>
                </Container>
            </div>
