                ...
                <Container>
                    <div className='flex justify-between items-center space-x-[50px]'>
                        <div className='w-[50%] border-b-2 text-white/50 pb-10'>
                            <h3 className='text-8xl text-white uppercase font-bold'>03</h3>
                            <h2 className='text-4xl text-[#0cf199] font-bold  mt-[20px] tracking-[3px]'>Frontend Project <span className='text-2xl ml-3 tracking-[1px]'>( Guess Game )</span></h2>
                            ...
                            <div className='mt-5 flex items-center space-x-10'>
                                <h2 className='text-2xl font-bold text-[#0cf199] tracking-[2px]'>HTML 5</h2>
                                <h2 className='text-2xl font-bold text-[#0cf199] tracking-[2px]'>CSS 3</h2>
                            ...
                            <div className='flex items-center space-x-5 mt-8'>
                                ...
                                <div className="flex justify-center items-center w-[50px] h-[50px] rounded-[50%] p-2 text-[24px] bg-gray-700 transition-all duration-200 ease-in hover:bg-[#0cf199]">
                                    <a href="https://guess-mocha.vercel.app"><FaGithub className='text-3xl text-white hover:text-black' /></a>
                                </div>
                            </div>
                        </div>
                        <div className='w-[50%]'>
                            <img src={project3} alt="" className='h-[500px]' />
                        </div>
                    </div>
                </Container>
            </div>
